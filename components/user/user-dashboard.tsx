        ...
        <aside className="hidden w-64 flex-col border-r bg-muted/40 md:flex">
          ...
          <div className="flex flex-col justify-between h-full">
            <nav className="flex-1 overflow-auto py-4">
              ...
              <div className="px-3 py-2">
                <h2 className="mb-2 px-4 text-xs font-semibold uppercase tracking-tight">History</h2>
                <div className="space-y-1">
                  <Button
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">Record new sales for today</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">UGX 0</div>
                      <p className="text-xs text-muted-foreground">Record new expenses for today</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">Current maize stock</p>
                    </CardContent>
                  </Card>
                </div>
